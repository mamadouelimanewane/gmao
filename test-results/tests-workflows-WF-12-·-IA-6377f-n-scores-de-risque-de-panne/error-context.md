...
- Name: tests\workflows.spec.ts >> WF-12 · IA Copilot >> WF-12-04 · Section scores de risque de panne
- Location: tests\workflows.spec.ts:636:3
...
Call log:
  - navigating to "http://localhost:5173/ia", waiting until "load"
